	...
	<div class="scfm-subsection">
		...
		if( $active_plugins ){
			...
			if( $n > 1 ){ ?>
				...
				?>
				<div>
					<a class="button" href="<?php echo admin_url( 'admin.php?page=eos_dp_mobile' ); ?>"><?php esc_html_e( 'Select active plugins on mobile with FDP','eos-scfm' ); ?></a>
				</div>
		<?php } } } ?>
		<div style="margin-top:64px">
			<a style="color:#B07700;font-weight:bold" class="button" href="https://shop.josemortellaro.com/downloads/specific-content-for-mobile-pro/" rel="noopener" target="_scfm_pro"><?php esc_html_e( 'Upgrade','eos-scfm' ); ?> <span style="position:relative;top:-8px;<?php echo ( is_rtl() ? 'right' : 'left' ); ?>:-6px;display:inline-block">👑</span></a>
		</div>
	</div>
</section>
